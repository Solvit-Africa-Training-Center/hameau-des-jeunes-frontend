...
import ResidentialCareSettingsContent from '@/components/AdminResidentialCareComponents/ResidentialCareSettingsContent';

function ResidentialCareSettings() {
    ...
    <>
      ...
      <div className="flex-1 md:ml-54 lg:ml-54">
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <ResidentialCareSettingsContent />
        </div>
      </div>
    </>
  );
...
export default ResidentialCareSettings;