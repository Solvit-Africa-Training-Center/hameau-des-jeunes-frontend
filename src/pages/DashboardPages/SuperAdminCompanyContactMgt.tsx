import { CompanyContactsMgtContent } from "@/components/SuperAdminCompanyContactMgtComponents/CompanyContactsMgtContent";
...
export const SuperAdminCompanyContactMgt = () => {
