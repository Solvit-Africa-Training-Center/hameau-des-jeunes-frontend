...
import IfasheTugufasheFamilyContent from '@/components/AdminIfasheTugufasheComponents/ITFamilyContent.tsx/IfasheTugufasheFamilyContent';

function IfasheTugufasheFamily() {
...
export default IfasheTugufasheFamily;