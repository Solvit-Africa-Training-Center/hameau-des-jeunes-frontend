...
import IfasheTugufasheClothesContent from '@/components/AdminIfasheTugufasheComponents/ITClothesContent/IfasheTugufasheClothesContent';

function IfasheTugufasheClothes() {
...
export default IfasheTugufasheClothes;