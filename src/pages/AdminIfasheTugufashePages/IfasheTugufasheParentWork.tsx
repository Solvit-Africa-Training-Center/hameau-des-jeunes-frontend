...
import IfasheTugufasheParentWorkContent from '@/components/AdminIfasheTugufasheComponents/ITParentWorkContent/IfasheTugufasheParentWorkContent';

function IfasheTugufasheParentWork() {
    ...
    <>
      ...
      <div className="flex-1 md:ml-54 lg:ml-54">
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <IfasheTugufasheParentWorkContent />
        </div>
      </div>
    </>
  );
...
export default IfasheTugufasheParentWork;