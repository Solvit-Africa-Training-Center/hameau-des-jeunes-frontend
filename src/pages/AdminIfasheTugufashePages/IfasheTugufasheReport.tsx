...
import IfasheTugufasheReportContent from '@/components/AdminIfasheTugufasheComponents/ITReportContent/IfasheTugufasheReportContent';

function IfasheTugufasheReport() {
...
export default IfasheTugufasheReport;