...
import IfasheTugufasheSponsorshipContent from '@/components/AdminIfasheTugufasheComponents/ITSponsorshipContent/IfasheTugufasheSponsorshipContent';

function IfasheTugufasheSponsorship() {
    ...
    <>
      ...
      <div className="flex-1 md:ml-54 lg:ml-54">
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <IfasheTugufasheSponsorshipContent />
        </div>
      </div>
    </>
  );
...
export default IfasheTugufasheSponsorship;