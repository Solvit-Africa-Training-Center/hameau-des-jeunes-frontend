...
const programs = [
  ...
  },
  {
    ...
    slug: "healthPost",
    title: "Health Post",
    subtitle: "Empowering Health Care to all",
    description: "The health post supports children living in the village",
    stastics: "300+ health checkups",
    image: edSupport,
    readMoreBtn: "Read More >>",
  },
  {
    ...
    subtitle: "Sharing the experience of humanity",
    description:
      "Gain valuable hands-on experience in commonly development, education, and social work.",
    stastics: "20+ People currently in work",
    image: famReunited,
    readMoreBtn: "Read More >>",
  },
  {
