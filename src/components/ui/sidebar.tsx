...
import { IoMdHelp, IoMdPhotos } from "react-icons/io";
...
const sidebarItems = [
  ...
  { icon: IoMdHelp, label: "About", href: "/aboutHameau" },
  { icon: GiFruitTree, label: "Programs Outcome", href: "/programsOutcome" },
  { icon: RiVipDiamondLine, label: "Our Values", href: "/ourValues" },
