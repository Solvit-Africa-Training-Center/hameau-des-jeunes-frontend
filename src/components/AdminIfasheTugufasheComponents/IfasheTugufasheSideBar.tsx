...
const sidebarItems = [
  { icon: LayoutDashboard, label: "Dashboard", href: "/IfasheTugufasheDashboard" },
...
export function IfasheTugufasheSideBar({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      <div className="mt-5 flex flex-col space-y-0.5 px-4">
        ...
        <h1 className="text-[#0F3D2E] text-center">Ifashe Tugufashe</h1>
      </div>
