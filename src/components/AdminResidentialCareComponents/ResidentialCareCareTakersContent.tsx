...
function ResidentialCareCareTakersContent() {
  return (
      ...
      <div className="flex w-full h-full">
        ...
        <div className="flex-1 p-4 sm:p-6 lg:p-8">
          ...
          <div className="flex flex-col sm:flex-row items-start justify-between mb-6 sm:mb-8 gap-4">
            <div>
              <h1 className="text-2xl sm:text-3xl font-semibold text-gray-900 mb-2">Caretaker Management</h1>
...
export default ResidentialCareCareTakersContent