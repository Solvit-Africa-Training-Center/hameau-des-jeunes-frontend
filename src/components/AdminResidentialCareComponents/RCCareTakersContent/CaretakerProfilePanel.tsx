        ...
        <div className="flex flex-col h-full overflow-y-auto">
          ...
          <div className="px-6 py-5 border-b">
            ...
            <div className="bg-gray-50 rounded-xl overflow-hidden divide-y divide-gray-200">
              <div className="flex items-center justify-between px-4 py-3">
                ...
                <span className="text-sm text-gray-900 font-medium">{caretaker.phone}</span>
              </div>
              <div className="flex items-center justify-between px-4 py-3">
                <span className="text-sm text-gray-500">Email</span>
                <span className="text-sm text-gray-900 font-medium">{caretaker.email}</span>
              </div>
              <div className="flex items-center justify-between px-4 py-3">
                <span className="text-sm text-gray-500">Status</span>
                <span className="text-sm text-green-600 font-medium">{caretaker.status}</span>
              </div>
            </div>
          </div>
          ...
          <div className="px-6 py-5">
            ...
            <div className="space-y-2">
              {caretaker.assignedChildren.map((child) => (
                <div
                  key={child.id}
