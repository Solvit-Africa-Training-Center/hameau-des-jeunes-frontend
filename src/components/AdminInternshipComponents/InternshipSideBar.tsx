...
const sidebarItems = [
  { icon: LayoutDashboard, label: "Dashboard", href: "/InternshipDashboard" },
  { icon: ClipboardCheckIcon, label: "Application", href: "/InternshipApplication" },
  { icon: GrOverview, label: "Internship Management", href: "/InternshipManagement" },
  { icon: VscFeedback, label: "Feedback", href: "/InternshipFeedbackContent" },
  { icon: IoSettingsOutline, label: "Settings", href: "/InternshipSettings" },
];

export function InternshipSideBar({ className }: { className?: string }) {
  ...
  return (
    ...
    <aside
      className={cn(
        // Base styles
        "flex flex-col h-screen w-54 shadow-xl bg-white shrink-0",
