...
import { useGetAllSuccessStoriesQuery, useCreateSuccessStoryMutation, useUpdateSuccessStoryMutation, useDeleteSuccessStoryMutation, type SuccessStory } from "@/store/api/successStoryApi";
