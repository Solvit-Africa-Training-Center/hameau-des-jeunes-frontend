        ...
        <div className="max-w-4xl text-center">
          ...
          <div className="flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
            <button
              ...
              className="w-full rounded-md bg-[#FDB714] px-6 py-2 text-sm font-semibold text-white transition-colors hover:bg-[#e5a513] sm:w-auto sm:px-8 sm:py-3 sm:text-base"
            >
              Start Donating
            </button>
            <button
              onClick={() => navigate("/contacts")}
              className="w-full rounded-md border-2 border-white bg-transparent px-6 py-2 text-sm font-semibold text-white transition-colors hover:bg-white hover:text-gray-900 sm:w-auto sm:px-8 sm:py-3 sm:text-base"
            >
              Get in touch
            </button>
          </div>
